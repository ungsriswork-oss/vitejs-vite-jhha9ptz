...
// ฟังก์ชันแปลง Base64 เป็น Blob (หัวใจสำคัญของการแก้ปัญหา PDF)
...
const MediaDisplay = ({ src, alt, className, isPdf }) => {
  ...
  // แสดงแค่ไอคอน PDF (ส่วนการเปิดดูเต็มๆ จะจัดการใน DetailModal)
